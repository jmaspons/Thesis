...
correlation among averaged loadings \textgreater{0.95}. Top panel: Loadings
mean $\pm$ standard deviation for the traits of each group of PCs. Bottom
panel: Relative weight of the life history for each group of PCs (see figure
\ref{fig:fig2.2} for details).}
\label{fig:fig2.3}
\end{figure}
...
and OV and reflects the productivity of the species in terms of investment in
reproduction. This axis is similar to the FSgt axis.
...
% All in all, this axis seems to sort highly fecund and small species with fast
% development in one end and,
...
$\lambda = 0.66 \pm 0.09$ and the PEP group with Pagel's
...
among other axes than FS, is quite low except for PEP axes and FSgt (-0.76) and
for PEP axes and iteroparity axes (mean correlation $0.76 \pm 0.11$). See table
\ref{tab:tabApp2.8} for detailed correlations among axes and traits.
...
\citep{Promislow1990,Bielby2007,Dobson2007} which resembles our PEP axis group.
